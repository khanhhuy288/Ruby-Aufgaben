...
puts print deep_collect_keys(h)       # {{2=>4},2,4,{5=>{1=>3, 2=>4}},5,1,7}

deep_to_a(h)            # [[[[2, 4]], [[4, [[[[5, [[1, 3], [2, 4]]]], [[7, 8]]]]]]]]
print deep_to_a({1=>2, 2=>3})                   # [[1, 2], [2, 3]]
...
deep_ary_plus_depth(ary) # [0, [1, [9, 22, [5, 7, 0], 8], 2, [11, [[[44]]], 0], 3],
# 1, [9, 22, [5, 7, 0], 8], 2, [5, 7, 0], 1, [11, [[[44]]], 0],
# 2, [[[44]]], 3, [[44]], 4, [44]]
...
deep_to_string(ary3) # [[[1,2,3,K[mp=(1,2),r=4]]],[4,5,6,7],K[mp=(1,2),r=33],2,3,8]
